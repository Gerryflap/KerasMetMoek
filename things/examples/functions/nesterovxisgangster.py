...
model.compile(loss=ks.losses.mean_squared_error, optimizer=ks.optimizers.SGD(lr=0.00005, decay=0.0000001, nesterov=True))

x = np.random.rand(4096)*100
y = x

history = model.fit(x, y, epochs=500, batch_size=256)
